...
public class CloudSpannerDialect extends Dialect {
  ...
  public CloudSpannerDialect() {
    ...
    registerFunction("string_agg",
        new StandardSQLFunction("string_agg", StandardBasicTypes.NSTRING));
    ...
    registerFunction("BYTE_LENGTH",
        new StandardSQLFunction("BYTE_LENGTH", StandardBasicTypes.BIG_INTEGER));
    registerFunction("CHAR_LENGTH",
        new StandardSQLFunction("CHAR_LENGTH", StandardBasicTypes.BIG_INTEGER));
    ...
    registerFunction("REGEXP_EXTRACT",
        new StandardSQLFunction("REGEXP_EXTRACT", StandardBasicTypes.NSTRING));
    ...
    registerFunction("REGEXP_REPLACE",
        new StandardSQLFunction("REGEXP_REPLACE", StandardBasicTypes.NSTRING));
    ...
    registerFunction("TO_CODE_POINTS",
        new StandardSQLFunction("TO_CODE_POINTS", StandardBasicTypes.BIG_INTEGER));
    ...
    registerFunction("JSON_QUERY",
        new StandardSQLFunction("JSON_QUERY", StandardBasicTypes.NSTRING));
    registerFunction("JSON_VALUE",
        new StandardSQLFunction("JSON_VALUE", StandardBasicTypes.NSTRING));

    registerFunction("ARRAY_LENGTH",
        new StandardSQLFunction("ARRAY_LENGTH", StandardBasicTypes.BIG_INTEGER));
    registerFunction("ARRAY_TO_STRING",
        new StandardSQLFunction("ARRAY_TO_STRING", StandardBasicTypes.NSTRING));
    registerFunction("GENERATE_ARRAY",
        new StandardSQLFunction("GENERATE_ARRAY", StandardBasicTypes.BIG_INTEGER));
    ...
    registerFunction("DATE_DIFF",
        new StandardSQLFunction("DATE_DIFF", StandardBasicTypes.BIG_INTEGER));
    ...
    registerFunction("FORMAT_DATE",
        new StandardSQLFunction("FORMAT_DATE", StandardBasicTypes.NSTRING));
    registerFunction("PARSE_DATE", new StandardSQLFunction("PARSE_DATE", StandardBasicTypes.DATE));
    registerFunction("UNIX_DATE",
        new StandardSQLFunction("UNIX_DATE", StandardBasicTypes.BIG_INTEGER));
    ...
    registerFunction("TIMESTAMP_DIFF",
        new StandardSQLFunction("TIMESTAMP_DIFF", StandardBasicTypes.BIG_INTEGER));
    ...
    registerFunction("UNIX_SECONDS",
        new StandardSQLFunction("UNIX_SECONDS", StandardBasicTypes.BIG_INTEGER));
    registerFunction("UNIX_MILLIS",
        new StandardSQLFunction("UNIX_MILLIS", StandardBasicTypes.BIG_INTEGER));
    registerFunction("UNIX_MICROS",
        new StandardSQLFunction("UNIX_MICROS", StandardBasicTypes.BIG_INTEGER));
    registerFunction("PARSE_TIMESTAMP",
        new StandardSQLFunction("PARSE_TIMESTAMP", StandardBasicTypes.TIMESTAMP));
